...
time_table_create = (
    ...
    hour INT NULL  CHECK ( hour >=0 ),
    day INT NULL  CHECK ( day >=0 ),
    week INT NULL  CHECK ( week >=0 ),
    month INT NULL  CHECK ( month >=0 ),
...
create_table_queries = [users_table_create, artists_table_create, songs_table_create,time_table_create, songplay_table_create]

drop_table_queries = [artist_table_drop, songplay_table_drop, song_table_drop, user_table_drop, time_table_drop]
